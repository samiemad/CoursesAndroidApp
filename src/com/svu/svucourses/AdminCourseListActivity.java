...
import com.svu.svucourses.adapter.AdminCoursesListAdapter;
...
public class AdminCourseListActivity extends AppCompatActivity {
	...
	AdminCoursesListAdapter adapter;
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case R.id.mnu_instructors:
			...
			break;
		case R.id.mnu_new:
			startActivity(new Intent(this, AdminCourseViewActivity.class));
			break;
		case R.id.mnu_search:
			startActivity(new Intent(this, AdminCourseSearchActivity.class));
			break;
		}
		return true;
	}
	...
	private Listener<String> lis = new Listener<String>() {
		...
		public void onResponse(String str) {
			...
			try {
				...
				adapter = new AdminCoursesListAdapter(items);
